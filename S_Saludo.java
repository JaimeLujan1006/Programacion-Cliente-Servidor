...
import java.net.*;
//Java IO es una API que está dirigida a leer y escribir datos (entrada y salida).
import java.io.*;
...
//limitamos la espera del servidor a 60 segundos = 60 000 milisegundos
    ...
    public void run() {
        ...
        while (true) {
            try {
                /* getLocalPort() Devuelve el puerto en el que escucha el socket del servidor. 
                Este método es útil si se pasó como el número de puerto en un constructor o se 
                dejó que el servidor encuentre un puerto automáticamente */
